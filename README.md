...
# 🧪 5. Optional --- Export Scan Report

Go inside the scan → **Report → Export**\
Choose: - HTML - PDF - CSV

------------------------------------------------------------------------

# 🧑‍💻 6. Suggested Mini‑Projects

### ✔️ Project 1 --- Nessus Scan Automation (Windows CMD)

Create a batch script to: - Start Juice Shop - Start Nessus service -
Open dashboard automatically

### ✔️ Project 2 --- Compare two scan reports

Scan v1 → fix something → scan v2\
Produce a comparison document.

### ✔️ Project 3 --- Write a short security analysis report

Include: - Top 5 vulnerabilities - How Nessus detected them - Mitigation
recommendations
...
-   Nessus Essentials is **for learning**, not enterprise‑grade
    scanning.
-   Juice Shop is intentionally vulnerable, so scanning it is safe and
    legal.
-   Always scan systems only when you have permission.
